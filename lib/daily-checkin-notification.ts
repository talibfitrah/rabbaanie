  ...
  try {
    await Notifications.scheduleNotificationAsync({
      content: {
        ...
        // A habit nudge does not carry interruptionLevel: timeSensitive — that
        // entitlement is justified to Apple once, on the prayer notifications
        // (see tests/adhan-ios-sound.test.ts). It still gets a sound like every
        // other iOS reminder here.

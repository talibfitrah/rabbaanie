  ...
  return [
    {
      ...
      fields: [
        {
          key: "education",
          label: tx(lang, "Type onderwijs", "Education type", "نوع التعليم"),
        },
        {
    ...
    },
    {
      ...
      fields: [
        {
          key: "familyLife",
          label: tx(lang, "Gezinsleven", "Family life", "الحياة الأسرية"),
        },
        {
          key: "relationWithFather",
          label: tx(
            lang,
            "Band met vader",
            "Bond with father",
        ...
        {
          key: "relationWithSiblings",
          label: tx(
            lang,
            "Band met broers/zussen",
            "Bond with siblings",
            "العلاقة مع الإخوة",
          ),
        },
        ...
        {
          key: "neighborhood",
          label: tx(lang, "Buurt", "Neighborhood", "الحي"),
        },
      ],
    },
    {
    ...
    },
    {
      ...
      fields: [
        {
          key: "goodThinking",
          label: tx(lang, "Goed denken", "Good thinking", "التفكير الإيجابي"),
        },
        {
          key: "badThinking",
          label: tx(lang, "Slecht denken", "Bad thinking", "التفكير السلبي"),
        },
        {
          key: "goodFeeling",
          label: tx(
        ...
        {
          key: "goodSpeaking",
          label: tx(lang, "Goed spreken", "Good speaking", "الكلام الإيجابي"),
        },
        {
          key: "badSpeaking",
          label: tx(lang, "Slecht spreken", "Bad speaking", "الكلام السلبي"),
        },
        {
          key: "goodDoing",
          label: tx(lang, "Goed gedrag", "Good behavior", "السلوك الإيجابي"),
        },
        {
          key: "badDoing",
          label: tx(lang, "Slecht gedrag", "Bad behavior", "السلوك السلبي"),
        },
      ],
    },
    {
      ...
      fields: [
        ...
        {
          key: "sleepQuality",
          label: tx(lang, "Slaapkwaliteit", "Sleep quality", "جودة النوم"),
        },
      ],
    },
    {
      ...
      fields: [
        {
          key: "mediaUse",
          label: tx(lang, "Mediagebruik", "Media use", "استخدام الوسائط"),
        },
        {
          key: "socialMedia",
          label: tx(lang, "Sociale media", "Social media", "وسائل التواصل"),
        },
        {
          key: "dailyStructure",
          label: tx(lang, "Dagstructuur", "Daily structure", "التنظيم اليومي"),
        },
      ],
    },
    {
      ...
      fields: [
        {
          key: "affinities",
          label: tx(lang, "Affiniteiten", "Affinities", "الميول"),
        },
        { key: "hobbies", label: tx(lang, "Hobby's", "Hobbies", "الهوايات") },
        {
          key: "goodHabits",
          label: tx(lang, "Goede gewoontes", "Good habits", "العادات الجيدة"),
        },
        {
          key: "badHabits",
          label: tx(lang, "Slechte gewoontes", "Bad habits", "العادات السيئة"),
        },
      ],
    },
  ];
    ...
    <View style={{ flex: 1, backgroundColor: colors.background }}>
      ...
      >
        ...
        >
          ...
          >
            {tx(lang, "Kindprofiel", "Child Profile", "ملف الطفل")}
          </Text>
          <Pressable
          ...
          >
            ...
            <View style={{ flex: 1 }}>
              ...
              >
                {genderLabel} —{" "}
                {age
                  ? `${age.years} ${tx(lang, "jaar", "years", "سنة")} ${age.months} ${tx(lang, "maanden", "months", "شهر")}`
                  : tx(lang, "Onbekend", "Unknown", "غير معروف")}
              </Text>
            </View>
          </View>
          <InfoRow
            label={tx(lang, "Geboortedatum", "Birth date", "تاريخ الميلاد")}
            value={
              child.birthDate ||
              tx(lang, "Niet ingevuld", "Not filled", "لم يُدخل")
            }
            colors={colors}
            isRTL={isRTL}
          />
          <InfoRow
            ...
            value={
              child.profileCompleted
                ? tx(lang, "Voltooid ✓", "Completed ✓", "مكتمل ✓")
                : tx(lang, "Onvolledig ⚠", "Incomplete ⚠", "غير مكتمل ⚠")
            }
            colors={colors}
            isRTL={isRTL}
            valueColor={
              child.profileCompleted ? colors.success : colors.warning
            }
          />
          <InfoRow
            label={tx(
            ...
            value={
              env?.completed
                ? tx(lang, "Voltooid ✓", "Completed ✓", "مكتمل ✓")
                : tx(lang, "Niet ingevuld", "Not filled", "لم يُكمل")
            }
            colors={colors}
            isRTL={isRTL}
        ...
        {(!env || !env.completed) && (
          ...
          >
            ...
            >
              {tx(
                lang,
                "Vul de omgevingsanalyse in om het volledige profiel te zien",
                "Fill in the environment analysis to see the full profile",
                "أكمل تحليل البيئة لرؤية الملف الكامل",
              )}
            </Text>
            <Pressable
              onPress={() =>
                router.push(`/child/environment?id=${child.id}` as any)
              }
              style={({ pressed }) => [
                {
                  marginTop: 10,
            ...
            >
              <Text style={{ color: "#fff", fontSize: 12, fontWeight: "700" }}>
                {tx(lang, "Nu invullen", "Fill in now", "أكمل الآن")}
              </Text>
            </Pressable>
          </View>
        )}
        ...
        >
          ...
          >
            <Text style={{ color: "#fff", fontSize: 13, fontWeight: "700" }}>
              {tx(lang, "Profiel bewerken", "Edit Profile", "تعديل الملف")}
            </Text>
          </Pressable>
        </View>
      </ScrollView>

        ...
        ...prev,
        {
          ...
          content:
            language === "ar"
              ...
              : "Sorry, er ging iets mis. Probeer opnieuw.",
        },
      ]);
      setIsLoading(false);
    },
      ...
      >
        ...
        >
          ...
          {messages.length === 0 && (
            ...
            >
              <Text
                style={{ color: colors.foreground, textAlign, lineHeight: 22 }}
              >
                {welcomeMessage}
              </Text>
            </View>
          ...
          {messages.map((msg, i) => (
            ...
            >
              ...
              {msg.role === "assistant" && (
                <ReportAiContent content={msg.content} surface="child-ask-ai" />
              )}
            </View>
          ))}
        ...
        >
          <TextInput
            ...
            placeholder={
              language === "ar" ? "اكتب سؤالك هنا..." : "Stel je vraag hier..."
            }

    ...
    <View style={[s.container, { backgroundColor: colors.background }]}>
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: insets.bottom + 100, paddingHorizontal: 16 }}>
        ...
        <View style={{ flexDirection: isRTL ? "row-reverse" : "row", alignItems: "center", justifyContent: "space-between", marginBottom: 4 }}>
          <Text style={[s.title, { color: colors.foreground, textAlign: isRTL ? "justify" : "left", writingDirection: isRTL ? "rtl" : "ltr", marginBottom: 0 }]}>
            {t("weekly.title")}
          </Text>
          <Pressable
        ...
        <View style={[s.infoCard, { backgroundColor: colors.primary + "08", borderColor: colors.primary + "30" }]}>
          ...
          {yearData?.characteristics && (
            <Text style={{ color: colors.muted, fontSize: 11, marginTop: 6, textAlign: isRTL ? "justify" : "left", writingDirection: isRTL ? "rtl" : "ltr", lineHeight: 16 }} numberOfLines={2}>
        ...
        <View style={[s.progressCard, { backgroundColor: overallPct === 100 ? "#F0FDF4" : colors.surface, borderColor: overallPct === 100 ? "#22C55E" : colors.border }]}>
          ...
          <View style={{ flexDirection: isRTL ? "row-reverse" : "row", alignItems: "center", marginBottom: 6 }}>
            <Text style={{ fontSize: 14, fontWeight: "800", color: colors.foreground, flex: 1, textAlign: isRTL ? "justify" : "left", writingDirection: isRTL ? "rtl" : "ltr" }}>
              {overallPct === 100 ? "✅ " : "📊 "}
          ...
          <Text style={{ color: colors.muted, fontSize: 12, marginTop: 6, textAlign: isRTL ? "justify" : "left", writingDirection: isRTL ? "rtl" : "ltr" }}>
              ...
              <View style={{ marginTop: 16 }}>
                ...
                >
                  <View style={{ flexDirection: isRTL ? "row-reverse" : "row", alignItems: "center" }}>
                    ...
                    <Text style={{ flex: 1, fontSize: 15, fontWeight: "700", color: "#92400E", marginHorizontal: 10, textAlign: isRTL ? "justify" : "left", writingDirection: isRTL ? "rtl" : "ltr" }}>
            ...
            {activeWeek.activities && activeWeek.activities.length > 0 && (
              <View style={{ marginTop: 12 }}>
                ...
                >
                  <View style={{ flexDirection: isRTL ? "row-reverse" : "row", alignItems: "center" }}>
                    <Text style={{ fontSize: 22 }}>🎯</Text>
                    <Text style={{ flex: 1, fontSize: 15, fontWeight: "700", color: "#5B21B6", marginHorizontal: 10, textAlign: isRTL ? "justify" : "left", writingDirection: isRTL ? "rtl" : "ltr" }}>
      ...
      >
        <View style={{ flexDirection: isRTL ? "row-reverse" : "row", alignItems: "center" }}>
          ...
          <View style={{ flex: 1, marginHorizontal: 10 }}>
            <Text style={{ fontSize: 14, fontWeight: "700", color, textAlign: isRTL ? "justify" : "left", writingDirection: isRTL ? "rtl" : "ltr" }}>
              {title}
            </Text>
            {/* Mini progress */}
            ...
            <>
              ...
              <View style={{ marginBottom: 8 }}>
                <View style={{ flexDirection: isRTL ? "row-reverse" : "row", alignItems: "center", gap: 6, paddingHorizontal: 8, paddingVertical: 6, backgroundColor: color + "10", borderRadius: 8, marginBottom: 4 }}>
                  ...
                  <Text style={{ color, fontSize: 12, fontWeight: "800", textAlign: isRTL ? "justify" : "left", writingDirection: isRTL ? "rtl" : "ltr" }}>
    ...
    return (
      ...
      >
        <View style={{ flexDirection: isRTL ? "row-reverse" : "row", alignItems: "center", gap: 10 }}>
          ...
          <View style={{ flex: 1 }}>
            <Text style={{ color: "#92400E", fontSize: 14, fontWeight: "700", textAlign: isRTL ? "justify" : "left", writingDirection: isRTL ? "rtl" : "ltr" }}>
              {tx(lang, "Omgevingsanalyse invullen", "Fill in environment analysis", "أكمل تحليل بيئة الطفل")}
            </Text>
            <Text style={{ color: "#78350F", fontSize: 12, marginTop: 4, textAlign: isRTL ? "justify" : "left", writingDirection: isRTL ? "rtl" : "ltr" }}>
            ...
            <Text style={{ color: "#B45309", fontSize: 11, marginTop: 6, fontWeight: "600", textAlign: isRTL ? "justify" : "left", writingDirection: isRTL ? "rtl" : "ltr" }}>
  ...
  return (
    <View style={{ marginTop: 16 }}>
      <View style={{ flexDirection: isRTL ? "row-reverse" : "row", alignItems: "center", gap: 8, marginBottom: 10 }}>
        <Text style={{ fontSize: 22 }}>💡</Text>
        <Text style={{ color: colors.foreground, fontSize: 15, fontWeight: "700", textAlign: isRTL ? "justify" : "left", writingDirection: isRTL ? "rtl" : "ltr" }}>
      ...
      {adviceItems.map((advice, idx) => (
        <View key={idx} style={{ borderRadius: 12, padding: 14, marginBottom: 8, backgroundColor: advice.bgColor + "15", borderWidth: 1, borderColor: advice.bgColor + "40" }}>
          <View style={{ flexDirection: isRTL ? "row-reverse" : "row", alignItems: "flex-start", gap: 8 }}>
            ...
            <View style={{ flex: 1 }}>
              <Text style={{ color: colors.foreground, fontSize: 13, fontWeight: "700", textAlign: isRTL ? "justify" : "left", writingDirection: isRTL ? "rtl" : "ltr", marginBottom: 4 }}>{advice.title}</Text>
              <Text style={{ color: colors.muted, fontSize: 12, lineHeight: 18, textAlign: isRTL ? "justify" : "left", writingDirection: isRTL ? "rtl" : "ltr" }}>{advice.text}</Text>
            </View>
          </View>
        </View>
      ))}
              ...
              <View style={{ flexDirection: isRTL ? "row-reverse" : "row", alignItems: "center", justifyContent: "space-between" }}>
                <View style={{ flex: 1 }}>
                  <View style={{ flexDirection: isRTL ? "row-reverse" : "row", alignItems: "center", gap: 6 }}>
                    ...
                    <Text style={{ color: colors.foreground, fontSize: 13, fontWeight: "700", flex: 1, textAlign: isRTL ? "justify" : "left", writingDirection: isRTL ? "rtl" : "ltr" }} numberOfLines={1}>
            ...
            {isExpanded && (
              <View style={{ marginTop: 12 }}>
                {phases.length > 0 ? phases.map((phase: any, phIdx: number) => {
                      ...
                      {isPhaseExpanded && (phase.steps || []).map((step: any, sIdx: number) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <View style={{ flex: 1 }}>
                              <Text style={{ color: isComplete ? colors.muted : colors.foreground, fontSize: 12, lineHeight: 18, textAlign: isRTL ? "justify" : "left", writingDirection: isRTL ? "rtl" : "ltr", textDecorationLine: isComplete ? "line-through" : "none" }}>
                                {step.text}
                              </Text>
                            </View>
                          </Pressable>
                  ...
                  <Text style={{ color: colors.foreground, fontSize: 12, lineHeight: 18, textAlign: isRTL ? "justify" : "left", writingDirection: isRTL ? "rtl" : "ltr" }}>
                    {plan.content}
                  </Text>
                )}

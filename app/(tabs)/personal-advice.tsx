...
function PersonalAdviceScreenInner() {
  ...
  async function fetchQuickTips() {
    ...
    try {
      ...
      const unresolvedIssues = (state.issues || [])
      ...
      if (quickTips.length === 0) {
        setQuickTips([
          tx(
            lang,
            "Maak du'aa voor uw gezin",
            "Make du'aa for your family",
            "ادعُ لعائلتك",
          ),
        ]);
      }
    ...
    >
        ...
        >
          ...
          {childrenSummary.map((child, i) => (
            <View
              key={i}
              style={{
                // Direction is JS-gated app-wide (lib/i18n.tsx); native RTL is off.
                flexDirection: isRTL ? "row-reverse" : "row",
                alignItems: "center",
                gap: 6,
                marginBottom: 3,
      ...
      >
        {quickTipsLoading ? (
          ...
          <>
            ...
            {quickTips.length > 0 && (
              <ReportAiContent
                content={quickTips.join("\n")}
                surface="personal-advice-quick-tips"
              />
            )}
          </>
        )}
      ...
      {llmLoading ? (
        ...
        <View style={{ gap: 10 }}>
          ...
          <ReportAiContent
            content={llmSections
              ...
              .join("\n\n")}
            surface="personal-advice-sections"
          />
        </View>
      ) : llmAdvice ? (
        <CollapsibleSection
        ...
        >
          ...
          <ReportAiContent content={llmAdvice} surface="personal-advice" />
        </CollapsibleSection>
      ) : (

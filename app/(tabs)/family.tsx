          ...
          >
            {(coParentsQuery.data ?? []).map((cp: any) => (
              ...
              >
                ...
                {/* Per-wife actions (الحيض وأثره + ملفها) — shared with the home
                    screen; gated to a confirmed spouse inside the component. */}
                <WifeCardActions cp={cp} partners={partners} viewerGender={pp.gender} />
              </Pressable>
            ))}
          </ExpandableSection>
        )}

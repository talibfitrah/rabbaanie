        ...
        {islamicTips.length > 0 && (
          <View style={st.sectionBox}>
            <View style={[st.sectionHeader, { backgroundColor: "#E8F5E9", flexDirection: isRTL ? "row-reverse" : "row" }]}>
              ...
              <Text style={[st.sectionHeaderText, { color: "#1B4332" }]}>{tx(lang, "Islamitische dag", "Islamic Day", "اليوم الإسلامي")} — {dig(hijri.day)} {lang === "ar" ? hijri.monthNameAR : hijri.monthName}</Text>
            </View>
